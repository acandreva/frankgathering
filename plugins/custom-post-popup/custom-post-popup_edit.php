...
Description: Display custom post with popup. Use this shortcode to display <strong>[CUSTOM_POST_POPUP type="post" orderby="none" posts_per_page="12" customclass="custom class"]</strong>
Version: 1.0
Author: Gnanavel
